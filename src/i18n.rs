...
fn pt(key: &str) -> &'static str {
    match key {
        ...
        "loading" => "Carregando…",
        "open_error" => "Não foi possível abrir o arquivo.",
        // settings
        ...
        "theme_dark" => "Escuro",
        "about" => "Sobre",
        "about_desc" => "Leitor e editor de arquivos XML em formato de tabela, nativo para Linux (GTK4), seguindo o tema do sistema.",
        "author" => "Autor",
        ...
        "ctx_row_clone_above" => "Clonar para cima",
        "ctx_row_clone_below" => "Clonar para baixo",
        "ctx_row_move_up" => "Mover para cima",
        "ctx_row_move_down" => "Mover para baixo",
...
fn en(key: &str) -> &'static str {
    match key {
        ...
        "theme_dark" => "Dark",
        "about" => "About",
        "about_desc" => "Reader and editor for XML table files, native to Linux (GTK4), following the system theme.",
        "author" => "Author",
        ...
        "ctx_row_clone_above" => "Clone upward",
        "ctx_row_clone_below" => "Clone downward",
        "ctx_row_move_up" => "Move up",
        "ctx_row_move_down" => "Move down",
